...
BUILDING_WALLS = [
    ...
    ((10.0, 240.0), (240.0, 240.0)),
    ((240.0, 240.0), (240.0, 10.0)),
    ((240.0, 10.0), (10.0, 10.0)),
    
    # 2. Building_BR(우측 하단)
    ((260.0, 10.0), (260.0, 240.0)),
    ((260.0, 240.0), (490.0, 240.0)),
    ((490.0, 240.0), (490.0, 10.0)),
    ((490.0, 10.0), (260.0, 10.0)),

    # 3. Building_TL (좌측 상단)
    ((10.0, 260.0), (10.0, 490.0)),
    ((10.0, 490.0), (240.0, 490.0)),
    ((240.0, 490.0), (240.0, 260.0)),
    ((240.0, 260.0), (10.0, 260.0)),

    # 4. Building_TR (우측 상단)
    ((260.0, 260.0), (260.0, 490.0)),
    ((260.0, 490.0), (490.0, 490.0)),
    ((490.0, 490.0), (490.0, 260.0)),
    ((490.0, 260.0), (260.0, 260.0))
...
MAX_SPEED_MPS = 16.67           # 차량 최대 예상 속도: 60km/h - 고정
